...
github-docs-index version, as reported by ``github-docs-index --version``

### Installation Method

How was github-docs-index installed (provide as much detail as possible, ideally
...
that github-docs-index is running in, as well as your operating system type and version.

### Actual Output

```
Paste here the output of github-docs-index (including the command used to run it),
